        ...
        <section className="bg-white lg:h-screen flex items-center justify-center">
            <div className="container mx-auto p-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 rounded-2xl overflow-hidden  lg:min-h-[800px] ">
                    {/* Stats Section */}
                    <div className="bg-[#fff8ba] p-8 lg:p-16 flex flex-col justify-between items-center space-y-8">
                        {/* Site Visits */}
                    ...
                    <div className="bg-[#e5ebff] p-8 flex flex-col items-center">
                        ...
                        <p className="text-lg md:text-xl lg:text-2xl lg:mt-3 font-semibold text-black leading-relaxed">Photography</p>
                        <p className="text-gray-600 text-lg md:text-xl lg:text-2xl font-semibold leading-relaxed mb-4 lg:mb-6">Candid Photography</p>
